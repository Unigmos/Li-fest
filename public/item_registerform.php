        ...
        <div class="items">
            <form action="/public/receiver/item_register.php" method="post">
                ...
                <div class="item_form">
                    ...
                    <input type="text" name="name" id="name" placeholder="例：500mlのお茶" class="content" require onkeyup="buttonavAilability()">
                    </div>
                </div>
                <div class="item_form">
                ...
                <div class="item_form">
                    <div class="item_quantity">
                        ...
                        <input type="number" name="quantity" id="quantity" placeholder="例：1" class="content" require onkeyup="buttonavAilability()">
                    </div>
                </div>
                <div class="item_form">
                    <div class="item_number">
                        <label for="amount_per_piece">1つ当たりの金額(円)</label>
                        <input type="number" name="amount_per_piece" id="amount_per_piece" placeholder="例：100" class="content" require onkeyup="buttonavAilability()">
                    </div>
                </div>
                <div class="item_form">
